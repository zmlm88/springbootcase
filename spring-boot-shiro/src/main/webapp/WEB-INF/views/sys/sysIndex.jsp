	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="productName"> 善林科技</span></div>
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好,<shiro:principal/> &nbsp;<span id="notifyNum" class="label label-info hide"></span></a>
						<ul class="dropdown-menu">
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${modeList.subList}" var="menu" varStatus="idxStatus">
							<c:set var="firstMenu" value="true"/>
							 <li class="menu ${not empty firstMenu && firstMenu ? ' active' : ''}">
						 			<a class="menu" href="javascript:" data-href="${ctx}/web/sys/menu/tree?parentId=${menu.tMenu.id}" data-id="${menu.tMenu.id}"><span>${menu.tMenu.name}</span></a>
							</li>
