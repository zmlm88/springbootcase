...
public class MyBatisMapperScannerConfig {
	...
	// try{
	// //
	// mapperScannerConfigurer.setBasePackage(PropertiesLoaderUtils.loadProperties(new
	// ClassPathResource(Const.CONFIG_PROPERTIES)).getProperty(Const.BASE_PACKAGE_KEY));
	// }catch(Exception e){
	// e.printStackTrace();
