...
import com.zm.web.configuration.mybatis.dialect.IDialect;
import com.zm.web.configuration.mybatis.util.ReflectHelper;
...
public class PageInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		if (page != null) {
			...
			// 获取分页Sql语句
			String pageSql = iDialect.dialect(page, new StringBuffer(sql));
	 ...
	 * @param iDialect
	 */
	public void setProperties(Properties properties, IDialect iDialect) {
		Assert.notNull(iDialect, "Mybatis方言为空");
	 ...
	 *            当前的数据库连接
	 */
	private void setTotalRecord(Object obj, MappedStatement mappedStatement, Connection connection, Page page) {
		...
		ReflectHelper.setFieldValue(countBoundSql, "additionalParameters", ReflectHelper.getFieldValue(boundSql, "additionalParameters"));
		ReflectHelper.setFieldValue(countBoundSql, "metaParameters", ReflectHelper.getFieldValue(boundSql, "metaParameters"));
